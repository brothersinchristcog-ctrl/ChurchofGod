...
async function fetchContactViaSoap() {
  try {
    // 1. SOAP Login
    ...
    console.log('✅ SOAP Auth Success!');

    // 2. REST Query using Session ID
    const soql = `SELECT Id, Name, Phone, MobilePhone, Mobile_App_ID__c, User_Type__c FROM Contact WHERE Name LIKE '%Sunil Babu%'`;
